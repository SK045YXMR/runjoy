...
# 実装した機能の紹介
1. ユーザー管理機能<br>GemのDeviseで実装しております。ユーザーの新規登録とログインができます。ユーザーログイン画面[![Image from Gyazo](https://i.gyazo.com/75ab58834f802d04831fd1574bbe3519.gif)](https://gyazo.com/75ab58834f802d04831fd1574bbe3519)<br>
...
5. コメント投稿機能<br>コメント投稿機能です。投稿詳細ページの投稿フォームからコメントを投稿できます。<br>
6. ユーザー詳細・編集機能<br>ユーザー詳細・編集機能です。ユーザー詳細ページへは、ログイン後のトップページの自身のニックネームをクリックする、投稿したユーザーのニックネームをクリックする、投稿詳細ページのユーザーのニックネームをクリックすることで、ユーザー詳細ページに遷移できます。<br>また、ユーザー情報の編集ページには、ログイン後、トップページ右上のユーザー編集ボタンから遷移できます。
